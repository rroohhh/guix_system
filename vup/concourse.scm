  ...
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append
             "https://github.com/concourse/concourse/releases/download/v"
             version "/concourse-" version "-linux-amd64.tgz"))
       (sha256
  ...
  (package
    ...
    (source
     (origin
       ...
       (uri (string-append
             "https://github.com/concourse/concourse/releases/download/v"
             version "/fly-" version "-linux-amd64.tgz"))
       (sha256
        (base32 "1dsf8d3khvjlqmh6riz50q1kd3g23g0385dskhrq1abqvvyarxvc"))))
    (build-system copy-build-system)
    (arguments
     '(#:install-plan '(("fly" "bin/fly"))))
    (synopsis
